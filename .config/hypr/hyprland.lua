...
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 5, bezier = "Spring", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 2, bezier = "Out", style = "slide" })
